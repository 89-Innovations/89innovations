...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fullName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Carey Price'>;
...
export interface ApiChildLinkChildLink extends Struct.CollectionTypeSchema {
  collectionName: 'child_links';
  info: {
    displayName: 'ChildLink';
    pluralName: 'child-links';
    singularName: 'child-link';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pageTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Page Title'>;
    publishedAt: Schema.Attribute.DateTime;
